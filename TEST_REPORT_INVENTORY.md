...
Code coverage is effectively generic as the core logic resides in the PostgreSQL RPC function (`001_process_coffee_sale.sql`). The TypeScript tests validate the _client interface_ and _expected behavior_.
