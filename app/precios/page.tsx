      ...
      >
        ...
        <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
          ...
          <ul className="text-sm text-blue-700 dark:text-blue-400 space-y-1">
            <li>
              Los precios se aplican automáticamente según el tipo de cliente al crear una venta.
            </li>
            <li>
              Tipos de cliente: Retail, Mayorista Pequeño, Mayorista Grande, Cafetería,
              Personalizado.
            </li>
            <li>
              Puedes crear listas de precios con descuentos globales o precios específicos por
              producto.
            </li>
          </ul>
        </div>
