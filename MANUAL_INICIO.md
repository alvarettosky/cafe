...
_Debes ver archivos como `README.md` y la carpeta `frontend`._
...
_Si no ves ningún mensaje de error, funcionó. Ahora tu terminal sabe qué herramientas usar._
...
_Esto ejecutará las pruebas del sistema e indicará si todo está "Verde" (Passed)._
