...
import { User, Building2, Store, Coffee, Settings } from 'lucide-react';
...
export function CustomerTypeSelect({ value, onChange, disabled = false }: CustomerTypeSelectProps) {
            ...
            {customerTypes.map(type => (
              ...
              >
                ...
                <div className="text-left">
                  <p
                    className={`font-medium ${type.value === value ? 'text-amber-700' : 'text-gray-800'}`}
                  >
                    {type.label}
                  </p>
                ...
                {type.value === value && (
                  <svg
                    className="h-5 w-5 text-amber-600 ml-auto"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
